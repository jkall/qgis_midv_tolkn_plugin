...
<qgis version="2.14.4-Essen" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueRelation" name="typ">
      <widgetv2config OrderByValue="1" AllowNull="1" FilterExpression="" UseCompleter="0" fieldEditable="1" Key="typ" Layer="zz_gvflode20160730184322019" Value="beskrivning" labelOnTop="0" AllowMulti="0"/>
    </edittype>
    ...
    <edittype widgetv2type="ValueRelation" name="intermag">
      <widgetv2config OrderByValue="1" AllowNull="1" FilterExpression="" UseCompleter="0" fieldEditable="1" Key="typ" Layer="zz_gvmag20160730184322035" Value="beskrivning" labelOnTop="0" AllowMulti="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{68536fe3-ca73-4e1a-9ccf-e48557ce07b2}">
      ...
      <rule filter="lower( &quot;intermag&quot; ) like '%huvudmag%'" key="{1aa27444-7ef8-4874-9866-6f626fa96d84}" symbol="4" label="utbyte med huvudmagasinet"/>
    </rules>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/Color" value="1~~1~~case when lower( &quot;Magasin&quot; ) like 'ytliga%'then  color_rgb( 0, 232, 255 ) else color_rgb( 0,0,255) end~~"/>
    ...
    <property key="labeling/fieldName" value="case when length(  &quot;label&quot; ) >0 then  &quot;label&quot; end"/>
