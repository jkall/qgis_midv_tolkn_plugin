...
<qgis version="2.14.5-Essen" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueRelation" name="typ">
      <widgetv2config OrderByValue="1" AllowNull="1" FilterExpression="" UseCompleter="0" fieldEditable="1" Key="typ" Layer="zz_tillromr20160817090500993" Value="beskrivning" labelOnTop="0" AllowMulti="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{93dfed8e-cc5e-4796-b11d-bc97e947cdf4}">
      ...
      <rule checkstate="0" filter=" &quot;typ&quot;  in('a','b','c')" key="{cb3cab03-c96d-4bd4-9229-e35b089f4364}" symbol="1" label="typ av tillrinningsområde - snedrastrering">
      ...
      <rule filter=" &quot;typ&quot;  in('a','b','c')" key="{c7b5a309-668b-430e-90df-78c683f5ecfc}" symbol="5" label="typ av tillrinningsområde - färgade yttre linjer">
        <rule filter=" &quot;typ&quot;  = 'a'" key="{fafbedcd-d0a2-4d18-b5ad-40e9855babad}" symbol="6" label="typ a"/>
      ...
      <rule checkstate="0" filter=" &quot;andel_t_mag_proc&quot; is not null and  &quot;andel_t_mag_proc&quot; !=''" key="{3492ba72-f4e8-45d4-b984-7708c6eb5fc6}" symbol="9" label="Andel av grundvattenbildningen som når magasinet">
        ...
        <rule filter=" &quot;andel_t_mag_proc&quot; >24.9 and  &quot;andel_t_mag_proc&quot; &lt;50" key="{dcd9961c-d653-4110-9d76-b367a2e20c48}" symbol="13" label="25-50%"/>
        <rule filter=" &quot;andel_t_mag_proc&quot; &lt;25" key="{1a2dbf75-aaf7-4383-972b-ee536cf9bb5f}" symbol="14" label="&lt;25%"/>
      </rule>
    </rules>
    <symbols>
      ...
      <symbol alpha="0.5" clip_to_extent="1" type="fill" name="10">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.5" clip_to_extent="1" type="fill" name="11">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.5" clip_to_extent="1" type="fill" name="9">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
