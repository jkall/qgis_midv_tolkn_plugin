...
<qgis version="2.14.8-Essen" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueRelation" name="typ">
      <widgetv2config OrderByValue="0" AllowNull="1" FilterExpression="" UseCompleter="0" fieldEditable="1" Key="typ" Layer="zz_tillromr20161111164328451" Value="beskrivning" labelOnTop="0" AllowMulti="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{93dfed8e-cc5e-4796-b11d-bc97e947cdf4}">
      ...
      <rule description="Andel=0-100% motsvarar H=240->0grader i en HSV-färg (S=100%,V=100%). Se https://en.wikipedia.org/wiki/HSL_and_HSV" filter=" &quot;andel_t_mag_proc&quot; is not null and  &quot;andel_t_mag_proc&quot; !=''" key="{df947031-8dec-4bbf-a53e-687e070f8dff}" symbol="1" label="Andel av grundvattenbildningen som når magasinet"/>
      <rule filter=" &quot;typ&quot;  in('a','b','c')" key="{c7b5a309-668b-430e-90df-78c683f5ecfc}" symbol="2" label="typ av tillrinningsområde - färgade yttre linjer">
        <rule filter=" &quot;typ&quot;  = 'a'" key="{fafbedcd-d0a2-4d18-b5ad-40e9855babad}" symbol="3" label="typ a"/>
        <rule filter=" &quot;typ&quot;  = 'b'" key="{a0e121f8-0359-4a6f-ab3b-95fcf7de30fa}" symbol="4" label="typ b"/>
        <rule filter="&quot;typ&quot;='c'" key="{09ef4993-9e60-4159-9c3d-f7500bf16b16}" symbol="5" label="typ c"/>
      </rule>
      <rule checkstate="0" filter=" &quot;typ&quot;  in('a','b','c')" key="{811feede-2c8c-4380-858e-7398a17bca8f}" symbol="6" label="typ av tillrinningsområde - snedrastrering">
        <rule filter=" &quot;typ&quot;  = 'a'" key="{36761ad2-1933-4105-add8-16447bf262c9}" symbol="7" label="typ a"/>
        <rule filter=" &quot;typ&quot;  = 'b'" key="{7462053b-50e4-4c02-9492-df9957cef693}" symbol="8" label="typ b"/>
        <rule filter="&quot;typ&quot;='c'" key="{1931dabd-f215-4037-9ddb-6826a0605821}" symbol="9" label="typ c"/>
      </rule>
    </rules>
    <symbols>
